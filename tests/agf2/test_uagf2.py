...
class KnownValues(unittest.TestCase):
    ...
    def test_uagf2_2_2(self):
        ...
        self.assertAlmostEqual(np.trace(uagf2.rdm1[0]), self.m.nalph, 6)
        self.assertAlmostEqual(np.trace(uagf2.rdm1[1]), self.m.nbeta, 6)
        self.assertAlmostEqual(uagf2.e_1body,    -74.92014093105244  , 6)
        self.assertAlmostEqual(uagf2.e_2body,    -0.0827314167951274 , 6)
        self.assertAlmostEqual(uagf2.e_hf,       -74.96117113786579  , 6)
        self.assertAlmostEqual(uagf2.e_corr,     -0.04170120998178106, 6)
        self.assertAlmostEqual(uagf2.e_tot,      -75.00287234784757  , 6)
