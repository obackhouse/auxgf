...
class KnownValues(unittest.TestCase):
    ...
    def test_ragf2_1_1(self):
        ...
        self.assertAlmostEqual(np.trace(ragf2.rdm1), self.m.nelec)
        self.assertAlmostEqual(ragf2.e_1body, -74.92304938877345   , 8)
        self.assertAlmostEqual(ragf2.e_2body, -0.08160143359098293 , 8)
        self.assertAlmostEqual(ragf2.e_hf,    -74.9611711378676    , 8)
        self.assertAlmostEqual(ragf2.e_corr,  -0.043479684496844584, 8)
        self.assertAlmostEqual(ragf2.e_tot,   -75.00465082236444   , 8)
        self.assertAlmostEqual(ragf2.chempot, 0.12835885829235852  , 8)
    ...
    def test_ragf2_2_2(self):
        ...
        self.assertAlmostEqual(np.trace(ragf2.rdm1), self.m.nelec)
        self.assertAlmostEqual(ragf2.e_1body, -74.92013981231922  , 8)
        self.assertAlmostEqual(ragf2.e_2body, -0.08273115876597667, 8)
        self.assertAlmostEqual(ragf2.e_hf,    -74.9611711378676   , 8)
        self.assertAlmostEqual(ragf2.e_corr,  -0.0416998332176064 , 8)
        self.assertAlmostEqual(ragf2.e_tot,   -75.0028709710852   , 8)
        self.assertAlmostEqual(ragf2.chempot, 0.13329294386150864 , 8)
    ...
    def test_ragf2_None_3(self):
        ...
        self.assertAlmostEqual(np.trace(ragf2.rdm1), self.m.nelec)
        self.assertAlmostEqual(ragf2.e_1body, -74.92061986016013  , 8)
        self.assertAlmostEqual(ragf2.e_2body, -0.08225785253628955, 8)
        self.assertAlmostEqual(ragf2.e_hf,    -74.9611711378676   , 8)
        self.assertAlmostEqual(ragf2.e_corr,  -0.04170657482882234, 8)
        self.assertAlmostEqual(ragf2.e_tot,   -75.00287771269642  , 8)
        self.assertAlmostEqual(ragf2.chempot, 0.1349123736479432  , 8)
