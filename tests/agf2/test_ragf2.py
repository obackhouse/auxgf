...
class KnownValues(unittest.TestCase):
    ...
    def test_ragf2_df(self):
        ...
        self.assertAlmostEqual(np.trace(ragf2.rdm1), self.m.nelec, 6)
        self.assertAlmostEqual(ragf2.e_1body, -74.92304938877345   , 3)
        self.assertAlmostEqual(ragf2.e_2body, -0.08160143359098293 , 3)
        self.assertAlmostEqual(ragf2.e_hf,    -74.9611711378676    , 3)
        self.assertAlmostEqual(ragf2.e_corr,  -0.043479684496844584, 3)
